...
from choix import choixinfo, choixinfo2, choixinfo3
...
stdscr.addstr("SHELL", curses.A_REVERSE)
...
#     print("====================================================\n")
	...
	quote_text_window.addstr(4,18,"Bienvenue sur le Shell interactif !",curses.color_pair(1))
	quote_text_window.addstr(6,10,"====================================================")
	quote_text_window.addstr(8, 23, "1 : Informations generales", curses.color_pair(4))
	quote_text_window.addstr(10, 23, "2 : Reseaux ", curses.color_pair(4))
	quote_text_window.addstr(12, 23, "3 : Processus ", curses.color_pair(4))
	quote_text_window.addstr(14,10,"====================================================")
	princip_window = quote_text_window.subwin(curses.LINES-6,curses.COLS-4, 3,2)
